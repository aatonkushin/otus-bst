...
public class Main {
     ...
     */
    private static final int length = 6_600;
    ...
    public static void main(String[] args) {
        for (int n = 5000; n <= 25000; n += 5000) {
            ...
            System.out.print("Generating bamboo tree with length " + length + ": ");
            sw.start();
            ...
            System.out.print("Generating random tree with length " + length + ": ");
            sw.start();
            for (int i = 0; i < length; i++) {
